...
## Focusing on other interesting improvements within RoboComp's inner workings we propose the next four activities. Those deal with some extensions to the current framework that have been highly demanded by users during this year.
...
## 11. Gazebo-RoboComp integration
