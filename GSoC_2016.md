...
7 **Object detection for simulated environments**
...
8 **Computer vision components and integration with openDetection**
...
9 **3D visualization of internal structures in real time**
